                        ...
                        <div class="card-body">
                            <ul class="list-group">
                                <li  id="address" class="list-group-item">
                                    <div class="md-v-line"></div><i class="fas fa-map-marked-alt mr-5"></i>{{ $place->address }}
                                </li>
                                <li id="phone" class="list-group-item">
                                    <div class="md-v-line"></div><i class="fas fa-phone mr-5"></i><a href="tel:{{ $place->phone }}">{{ $place->phone }}</a>
                                </li>
                                <li id="email" class="list-group-item">
                                    <div class="md-v-line"></div><i class="fas fa-envelope mr-5"></i><a href="mailto:{{ $place->email }}">{{ $place->email }}</a>
                                </li>
                            </ul>
                        </div>
                    </div>
