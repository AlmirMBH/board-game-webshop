            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        ...
                        @if(Session::has('create_partComp'))
                            <span id="create_partComp"></span>
                        @endif
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Participating companies with pagination</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                    ...
                                    @foreach($partcompanies as $item)
                                        <tr>
                                           ...
                                           {{-- @if($item->is_availability == 1)
                                            ...
                                            @endif--}}
                                            <td><a href="{{route('edit-partcompanies', $item->id)}}">View</a></td>
...
@section('script')
    ...
    <script>
        $(function () {
            ...
            if ( $( "#create_partComp" ).length ) {
                toastr.success('{{session('create_partComp')}}')
            }
        });
    </script>
@endsection
